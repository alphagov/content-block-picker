...
describe("EmbedCodeHighlight", () => {
  ...
  let embedCodeHighlight = new EmbedCodeHighlight(mockApiClient, overlay);
...
Something else ${mockEmbedCode2} here too.`;
  ...
  beforeEach(() => {
    ...
    embedCodeHighlight = new EmbedCodeHighlight(mockApiClient, overlay);
  });
...
Something else <mark class="content-block-highlight__mark">{{embed:content_block_contact:bad}}</mark> here too.`);
  ...
  describe("update", () => {
    ...
    it("should highlight invalid embed codes after previews", async () => {
